...
import cn.softbank.purchase.widget.PinYin;
...
public class CityData
{
	...
	public static List<ContactItemInterface> getSampleContactList(List<String> datas)
	{
		List<ContactItemInterface> list = new ArrayList<ContactItemInterface>();
		
		for(int i = 0; i < datas.size(); i++)
		{
			String cityName = datas.get(i);
